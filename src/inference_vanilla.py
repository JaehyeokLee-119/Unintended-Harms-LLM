...
from utils.prompt_templates import LONG_PROMPT_COMPLETION, VANILLA_PROMPT_COMPLETION, VANILLA_PROMPT_INSTRUCTION
...
def main(
    ...
    batch_size = 64,
    max_tokens = 64,
    result_path: str = "./results_vanilla",
    ...
    stops = ['\n', '.'] if dataset_name in ['rtp', 'holisticbiasr'] else []
